...
<div class="container">  
    ...
    <fieldset>
      <input placeholder="Identificador do Cliente" type="text" tabindex="1"  autofocus name="cliente" value="">
      <input placeholder="Buscar por pedido"  type="text" name="id" value="" size="32">
    </fieldset>
    <fieldset>
