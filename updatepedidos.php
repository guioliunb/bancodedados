...
<div class="container">  
    ...
    <fieldset>
      <input placeholder="Nº Pedido" type="text" tabindex="1" autofocus  type="number" name="kaka" value="" size="11">
    </fieldset>
    <fieldset>
    ...
    <fieldset>
      ...
      <input placeholder="Status Cliente (A ou B)" tabindex="5" type="text" name="status" value = "" size="1">
      <input tabindex="5"  type="file" name="image" >
    </fieldset>
    <fieldset>
            <td><input type="hidden" name="update2" value="update2"/></td>
